...
map('v', '<leader>lf', '<cmd>lua vim.lsp.buf.range_formatting()<CR>')
map('n', '<leader>li', '<cmd>lua vim.lsp.buf.code_action({ context = { only = { "source.organizeImports" } }, apply = true, })<CR>')
